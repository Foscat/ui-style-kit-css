...
|---|---:|---:|---|
| `ui-style-kit-css/dist/ui-style-kit.min.css` | ~334 KB | ~42 KB | Compatible runtime UI-system switchers and demos |
| `ui-style-kit-css/visual.min.css` | ~326 KB | ~41 KB | Runtime visual switching with consumer-owned layout |
| `ui-style-kit-css/with-bridge.css` | ~407 KB | ~47 KB | Deprecated runtime switcher plus stateful bridge |
