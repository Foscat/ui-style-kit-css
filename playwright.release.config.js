...
const releaseSmokePatterns = [
  ...
  /semantic card controls remain contained/,
  /short viewports preserve sticky controls and internal scrolling/,
  /icon-only actions retain neutral or subtle paint/,
